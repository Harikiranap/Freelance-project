...
export default function PaymentPage() {
  ...
  const platformFee = Math.round(bidAmount * 0.02);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm space-y-6">
            ...
            <div className="p-5 rounded-2xl border border-emerald-100 bg-emerald-50/30 flex gap-4">
        ...
        <div className="lg:col-span-5 flex flex-col items-center">
          ...
          <div className="w-full max-w-sm bg-white border border-slate-200/80 shadow-2xl relative p-6 pt-8 pb-10 flex flex-col gap-4 font-mono text-slate-800 rounded-lg">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[8px] text-slate-400 text-right uppercase tracking-wider">Prices include 2% platform facilitation fee</p>
            </div>
            ...
            <div className="flex justify-center my-1">
              {job.paymentStatus === 'pending' ? (
                ...
                <div className="border-2 border-dashed border-emerald-600 text-emerald-600 font-extrabold text-sm px-6 py-1.5 rotate-[-4deg] rounded tracking-widest uppercase flex items-center gap-1 animate-pulse">
          ...
          {job.paymentStatus === 'pending' && user?.role === 'client' && (
            <motion.button
              ...
              disabled={isPaying}
              className="mt-6 w-full max-w-sm py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-2xl shadow-xl hover:shadow-blue-500/20 transition-all flex items-center justify-center gap-2.5 disabled:opacity-50"
            >
              {isPaying ? (
                <>
          ...
          {job.paymentStatus !== 'pending' && (
            <div className="mt-4 p-3 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-xl text-center text-xs font-semibold max-w-sm">
